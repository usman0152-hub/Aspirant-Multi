...
#AspirantEdge
    invoice_valid = fields.Date(string="Quotation/Invoice Valid")
    ...
    exporter = fields.Text(string="EXPORTER", help="COMPLETE NAME AND ADDRESS", placeholder="COMPLETE NAME AND ADDRESS")
    booking_no = fields.Char(string="BOOKING NO")
    bill = fields.Char(string="BILL OF LANDING NO")
    export_reference = fields.Char(string="EXPORT RFERENCE NO")
    fmc = fields.Char("FMC NO")
    point = fields.Char("POINT And COUNTRY OF ORIGIN OF GOODS")
    notify = fields.Char(string="NOTIFY", help="COMPLETE NAME AND ADDRESS", placeholder="COMPLETE NAME AND ADDRESS")
    delivery = fields.Char(string="DELIVERY AGENTS DETAIL")
    carriage = fields.Char(string="PRE-CARRIAGE BY")
    place = fields.Char(string="PLACE OF RECEIPT")
    vessel = fields.Char("VESSEL")
    port = fields.Char("PORT OF LOADING")
    terminal = fields.Char("LOADINGS PER/TERMINAL")
    no_of_bs = fields.Integer("NO OF BS(L)")
    discharge = fields.Char("PORT OF DISCHARGE")
    port_delivery = fields.Char("PORT OF DELIVERY")
    freight_charges = fields.Char("FREIGHT & CHARGES PAYABLE AT/BY")
...
class AccountMoveLine(models.Model):
    ...
    cntr_no = fields.Char("CNTR.NO. W/SEALS NO'S"
                          "MARKS & NO'S"
                          )

    prize_cash = fields.Monetary(string="Prize In Cash")
    domain = fields.Monetary(string="Actual Prize")
    profit = fields.Monetary(string="Profit")
